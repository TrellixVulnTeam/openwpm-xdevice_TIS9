...
#fontchanger(0)
time.sleep(60*60)
p1 = multiprocessing.Process(target=runnerfunc3, args=(11,))
p2 = multiprocessing.Process(target=runnerfunc3, args=(12,))
p3 = multiprocessing.Process(target=runnerfunc3, args=(13,))
p4 = multiprocessing.Process(target=runnerfunc3, args=(14,))
p5 = multiprocessing.Process(target=runnerfunc3, args=(15,))
p1.start()
p2.start()
p3.start()
p4.start()
